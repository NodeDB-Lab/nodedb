...
mod tests {
    ...
    fn picker_orders_inputs_by_flush_lsn() {
        // Build a synthetic manifest by hand and only test the static
        // picker logic — `ArrayStore` integration is covered separately.
        ...
        // Manually replicate picker.pick on the manifest fragment.
