...
pub(in crate::control::cluster::calvin::scheduler::driver::core) fn participant_change_sets(
    plans: &[PhysicalPlan],
...
pub(in crate::control::cluster::calvin::scheduler::driver::core) fn plans_have_primary_write(
    plans: &[PhysicalPlan],
) -> bool {
    plans.iter().any(|plan| {
...
pub(in crate::control::cluster::calvin::scheduler::driver::core) fn plans_have_returning(
    plans: &[PhysicalPlan],
) -> bool {
