...
/// timeout plus replay of a retained log, but finite — a group that cannot
/// elect or cannot apply is a failure, not a reason to hang forever. The
/// caller supplies it from `[server] data_group_recovery_timeout_ms`.
