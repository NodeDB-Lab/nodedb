...
impl CoreLoop {
    ...
    pub(in crate::data::executor) fn execute_ts_raw_scan(
        ...
        // Cells leave the engine in its own millisecond unit; the response
        // boundary converts declared instants once, after every predicate,
        // sort and computed column has run.
