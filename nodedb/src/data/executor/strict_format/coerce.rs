...
///
/// A non-numeric element is rejected by index and type. Dropping one silently
/// would report the literal as having fewer elements than the user wrote and
/// surface the mismatch as an internal error.
